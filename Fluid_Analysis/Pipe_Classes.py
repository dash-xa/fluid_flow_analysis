...
class Pipe_FlowPath_liquid_study1: #define your flow path here
    def __init__(self, pipe, fluid, IS_1_cv, IS_1_D, CV_1_cv, CV_1_D, bend_angles):
        ...
        # K due to components
        self.K                    += Cv_to_K(IS_1_cv, D=IS_1_D) # Isolation Valve IS-1
        self.K                    += Cv_to_K(CV_1_cv, D=CV_1_D) # Check Valve CV-1
